...
data.raw["recipe"]["lex-flying-gunship"].ingredients = {
    ...
    { type = "item", name = "rhenium-alloy-plate", amount = 100 },
    { type = "item", name = "rhenium-plate",       amount = 400 },
...
data.raw["recipe"]["lex-flying-cargo"].ingredients = {
    ...
    { type = "item", name = "rhenium-alloy-plate", amount = 250 },
    { type = "item", name = "rhenium-plate",       amount = 300 },
    { type = "item", name = "advanced-circuit",      amount = 20 },
}

data.raw["recipe"]["lex-flying-heavyship"].ingredients = {
    { type = "item", name = "electric-engine-unit",  amount = 150 },
    { type = "item", name = "rhenium-alloy-plate", amount = 700 },
